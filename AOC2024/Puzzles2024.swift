...
class Puzzles2024: PuzzlesRepo {
	init() {
		...
		puzzles = Puzzles(puzzles: [
			...
			Puzzle(year: year, id: 8, name: "Resonant Collinearity") { Solve8() },
			Puzzle(year: year, id: 9, name: "Disk Fragmenter") { Solve9() },
			Puzzle(year: year, id: 10, name: "Hoof It") { Solve10() },
			Puzzle(year: year, id: 11, name: "Plutonian Pebbles") { Solve11() },
			Puzzle(year: year, id: 12, name: "Garden Groups") { Solve12() },
			Puzzle(year: year, id: 13, name: "Claw Contraption") { Solve13() },
			/*
